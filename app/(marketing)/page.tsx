...
import localFont from "next/font/local"; //直接引入font
import { Poppins } from "next/font/google"; //从google引入font
...
const headingFont = localFont({
  src: "../../public/fonts/GeistMonoVF.woff" //引入并使用字体，我这里还是用的默认
});
  ...
  return (
    <div className="flex items-center justify-center flex-col">
      <div className={cn(
        ...
        text-white px-4 p-2 rounded-md pb-4">
          work forward
        </div>
      </div>
      ...
      <Button className="mt-6 font-semibold text-gray-300" size="lg" asChild>
        <Link href="/sign-up">
